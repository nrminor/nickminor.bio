...
export function sortMDByPinned(posts: Array<CollectionEntry<"blog" | "project">>) {
  return posts.sort((a, b) => {
...
export function getPostsByTag(tag: string, posts: Array<CollectionEntry<"blog">>) {
...
export function getPostsBySeries(series: string, posts: Array<CollectionEntry<"blog">>) {
  return posts.filter((post) => {
    if (post.data.series) {
